...
- 已确认观察项目：60
- 当前关注度第 1：anywhere-labs/deepseek-harness-desktop（1326 stars）
- Stars 总量第一分类：桌面端与启动器（2235 stars）
- 观察窗口动量：等待第二个快照
- 最近创建项目：xiaobright/dsh-anchored-standard
- 公开所在地（维护者账号）：国内 13 / 海外 1 / 未知 42
- 中文可读简介：60/60
